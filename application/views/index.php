...
<link rel="stylesheet" type="text/css" href="<?php echo base_url().'css/login/animate.css';?>" />
...
<form id="formid"  name= "myform" method = 'post'  action = "<?php echo base_url().'index.php/admin/login/';?>">
<div class="LoginWindow">
	<div>
		<div class="login">
			<p><input type="text" name="name" id="id" placeholder="用户名" value=""></p>
...
<h2 align="center" style='color:red;'><?php echo $notice;?></h2>
