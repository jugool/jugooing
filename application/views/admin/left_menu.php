<div class="layout_left_menu">
    <ul class="tendina" id="menu">
        <li class="childUlLi">
            <a href="javascript:;" target="menuFrame"><i class="glyph-icon icon-home"></i>首页</a>
            <ul style="display: none;">
                <li><a href="admin/main" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>用户添加</a></li>
            </ul>
        </li>
        <li class="childUlLi">
        ...
        <li class="childUlLi">
            <a href="#" target="menuFrame"> <i class="glyph-icon icon-reorder"></i>菜单管理</a>
            <ul style="display: none;">
        ...
        <li class="childUlLi">
            <a href="#"> <i class="glyph-icon  icon-location-arrow"></i>统计管理</a>
            <ul style="display: none;">
		...
		<li class="childUlLi">
            ...
            <ul style="display: none;">
                <li><a href="#"><i class="glyph-icon icon-chevron-right"></i>系统配置</a></li>
            </ul>
        </li>
    </ul>
</div>