    ...
    <div class="row">
        <section>
            <div class="col-lg-8 col-lg-offset-2">
                <form id="defaultForm" method="post" class="form-horizontal" action="uupdate">
					
                    <div class="form-group">
                        <label for="username" class="col-xs-2 control-label">名称</label>

                        <div class="col-xs-2">
                        <input type="hidden" id="username" class="form-control" name="id" value="<?php echo $user->id;?>"/>
                            <input type="text" id="username" class="form-control" name="username" value="<?php echo $user->name;?>"/>
                        </div>
                    </div>
					<div class="form-group">
						...
						<div class="col-xs-3">
                            <select class="form-control" name="user_type">
                                ...
                                <option value="0" <?php if($user->type == 0){echo "selected='selected'"; }?>>管理员</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-3">
                            <input type="job_number" class="form-control" name="job_number" value="<?php echo $user->job_number;?>"/>
                        </div>
                    </div>
                    <div class="form-group">
